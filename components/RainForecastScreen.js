...
const styles = StyleSheet.create({
  ...
  burgerWrapper: {
    position: 'absolute',
     // Ajuste cette valeur en fonction de la taille du menu burger
    left: 0,
     // Position horizontale du burger
    zIndex: 1, // Le burger est au-dessus de la carte
  },
  webview: {
    top : 50,
    flex: 1,
...
const styles = StyleSheet.create({
  ...
  burgerWrapper: {
    position: 'absolute',
    top: height * 0.05, // Ajuste cette valeur en fonction de la hauteur du menu
    left: width * 0.05,
    zIndex: 1,
  },
  webview: {
  ...
  loaderContainer: {
    ...
    top: '50%',
    left: '50%',
    transform: [{ translateX: -width * 0.25 }, { translateY: -height * 0.1 }],
    alignItems: 'center',
  },
  loaderText: {
    marginTop: 10,
